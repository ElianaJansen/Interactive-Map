...
let ign = L.tileLayer(
  ...
  {
    attribution:
      '<a href="http://leafletjs.com" title="A JS library for interactive maps"></a> <a href="http://www.ign.gob.ar/AreaServicios/Argenmap/IntroduccionV2" target="_blank">Instituto Geográfico Nacional</a> + <a href="http://www.osm.org/copyright" target="_blank">OpenStreetMap</a>',
    minZoom: 2,
    maxZoom: 18,
  }
).addTo(map);
...
legend.update = function () {
  this._div.innerHTML =
    "<h4> Territorio Argentino  </h4>" +
    "<h5> Comparando Capas Simultáneamente </h5>";
};
legend.addTo(map);
